...
<head>
	...
	<script src="//netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
		...
		{{ HTML::script('js/login_professional.js') }}
	<script>
...
<div class='container' style='min-height: 500px;'>
			...
			<div class='top-sidebar' style='display: none;'>
				...
				<form class='form-horizontal'>
					<div class='form-group'>
						<div class='col-md-12'>
							<input id='name' name='name' type='text' class='form-control' placeholder='Nombre de página'>
						</div>
					</div>
					<div class='form-group'>
						<div class='col-md-12'>	
	...
	<div class='row'>
		<div id='more_info_form' class='col-md-10 col-md-offset-1' style='display: none;'>
			<h2>
			...
			<div class='row'>
				<form>
					<div class='col-xs-5'>
						<div class='form-group'>
							<input id='city' type='text' name='city' class='form-control' placeholder='Ciudad'>
						</div>
						<div class='form-group'>
							<input id='country' type='text' name='country' class='form-control' placeholder='País'>
						</div>						
						<div class='form-group'>
							<input id='url' type='text' name='url' class='form-control' placeholder='Sitio web'>
						</div>
						<div class='form-group'>
							<input id='address' type='text' name='address' class='form-control' placeholder='Dirección'>
						</div>

						<div class='form-group' style='margin-top: 40px;'>
							<label for='type'>Elige una categoria</label>
							<select id='type' type='text' name='type' class='form-control'>
								<option value='despacho'>Despacho de Arquitectura</option>
								<option value='empresa'>Empresa de materiales</option>
								<option value='institucion'>Institución o organización</option>
							</select>
						</div>
					</div>
					...
					<div class='col-xs-5'>
						<div class='form-group' style='margin-bottom: 54px;'>
							<textarea id='description' placeholder='Una breve descripcion' class='form-control' rows='4' style='width: 100%; resize: none;'></textarea>
						</div>
						<div class='form-group'>
					...
					<button style='width: 10%; position: absolute; bottom: 43px; right: 30px;' type="submit" class="btn btn-green">Ir a mi perfil</button>
